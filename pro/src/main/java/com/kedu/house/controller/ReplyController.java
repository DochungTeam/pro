...
import com.kedu.house.service.ReplyService;
...
public class ReplyController {
  ...
  public ResponseEntity<List<ReplyDto>> list(@PathVariable("hno") Integer hno) {
  ...
  public ResponseEntity<Map<String, Object>> listPage(
    ...
    try {
      ...
      List<ReplyDto> list = service.listReplyPage(hno, cri);
