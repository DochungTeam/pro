							...
							<form role="form" method="post" name="frm" id="insertForm">
								...
								<div class="insert_form">
									...
									<table style="width: 750px">
										...
										<tr>
											<th>전화번호 *</th>
											<td><input type="text" name="hphone" size="20"
												maxlength="11">(전화번호는 - 없이 입력해주세요.)</td>
										</tr>
										<tr>
											<th>주소 *</th>
											<td><input type="text" name="haddr" id="hhaddr" readonly
												style="width: 400;"> <input type="button"
												value="주소 검색" class="haddr" style="width: 100;"> <input
												type="hidden" name="hmapx" id="hhmapx"> <input
												type="hidden" name="hmapy" id="hhmapy"></td>
										</tr>
										<tr>
											<th>맛집테마 *</th>
